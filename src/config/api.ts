...
import { stringifyParams } from "@/lib/api";
import { COOKIE_KEY, ROUTE, ROUTER } from "@/lib/constants";

const defaultOptions = {};
const API_URL = `http://${process.env.BACKEND_HOSTNAME}:${process.env.BACKEND_PORT}/api/v1`;
